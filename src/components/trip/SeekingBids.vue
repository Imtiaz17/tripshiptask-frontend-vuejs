<template>
 ...
 -->
                                                ...
                                                <div class="column is-3" v-else-if="bid.user_id==id && bid.co>0">
                                                    <label class="label">Counter Offer:</label>
                                                    <span class="counteramt">{{bid.co}} BDT</span>
                                                    <span>
                                                ...
                                                <div class="column" v-if="bid.trip_owner==id">
                                                    ...
                                                    <div v-else-if="bid.paid==1" style="float:right;">
                                                        ...
                                                        <div style="margin-top:12px;margin-left:6%;" v-if="bid.feedback_got==0">
                                                            <a @click="ridetakerFeedbackModal(index,bid.trip_username,bid.payment_method)" class="button success-btn btn-dash is-raised rounded ripple  btn-fade">Give a rating</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        <a-drawer :width="720" :visible="completedfeedbackShow" :body-style="{ paddingBottom: '80px' }" @close="onClose">
            <div v-for="(bidsrecord,index) in bidsData.bids" :key="index" v-if="recordContent(index)">
                <div class="header">
         ...
         <a-drawer :width="720" :visible="postedfeedbackShow" :body-style="{ paddingBottom: '80px' }" @close="onClose">
            <div v-for="(bidsrecord,index) in bidsData.bids" :key="index" v-if="postedRecordContent(index)">
                <div class="header">
                    <vs-avatar size="70px" :src="'/images/' + bidsrecord.photo" style="float:left" />
                    <div class="con-colors" style="overflow:hidden">
                        <ul>
