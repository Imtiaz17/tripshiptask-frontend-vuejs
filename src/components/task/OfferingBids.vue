            ...
            <div class="flex-card light-bordered light-raised trip-info" id="element2">
                <div class="flex-body">
                    <div class="content">
                        ...
                        <article class="media recent-post" v-if="bidsData.bids_count==0">
                                        ...
                                        <div class="post">
                                            ...
                                            <div class="post-content">
                                                ...
                                                <div class="columns" :class="bid.accepted==1?'ab':'cd'">
                                                    ...
                                                    <div class="column is-4" v-if="bid.task_owner==id">
                                                        <a style="float:right;" v-if="bid.accepted==0 && bid.paid==0" @click="accept(bid.id)" class="button info-btn btn-dash is-raised rounded ripple  btn-fade">Accept</a>
                                                        <span style="float:right;" v-if="bid.accepted==1 && bid.complete==0" class="ongoing">Offer accepted
                                                        </span>
