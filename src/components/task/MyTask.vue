        ...
        <div class="columns">
            <div class="column is-10 is-offset-1">
                ...
                <!-- <el-tabs type="border-card">
                    <el-tab-pane label="Posted Task">
                        <div v-if="isTLoading">
                            <img class="loading" :src="getPhoto()">
                        </div>
                        <div v-else>
                            <posted-task v-if="mytasks" :data="mytasks.tasks"></posted-task>
                        </div>
                    </el-tab-pane>
                    <el-tab-pane label="Completed Task">
                        <completed-task v-if="mytasks" :data="mytasks.bids"></completed-task>
                    </el-tab-pane>
                </el-tabs> -->
            </div>
...
<script>
import offeredTask from './OfferedTask'
import seekedTask from './SeekedTask'
import completedTask from './CompletedTask'
import { mapActions, mapGetters } from 'vuex';
export default {
    components: { offeredTask, seekedTask, completedTask },
    data() {
        return {
            isLoading: false,
            first: true,
