            ...
            <table class="table is-accent">
                ...
                <tbody>
                    <tr v-for="(item,index) in results" :key="index">
                        ...
                        <td>
                            <button @click="offertask(item)" v-if="today>item.date" class="button is-small info-btn raised rounded btn-left">Repost</button>
...
export default {
    ...
    methods: {
        offertask(info) {
            ...
            EventBus.$emit('OfferTaskRepost', info)
        }
    },
